    ...
    <>
      ...
      <div className="bg-slate-900 h-screen text-white flex justify-center">
        <div className="w-2/5 justify-center bg-slate-600 ">
          <h3 className="pl-3 pt-2 border-b-2 pb-2 border-gray-400">
            <FontAwesomeIcon icon={faFire} className="text-yellow-600" />{" "}
            Account
          </h3>
          ...
          <div className="flex justify-between text-blue-400 font-semibold">
            <p className="ml-3 mt-2">
              ...
              <Link to={"/"}>
                {" "}
                <FontAwesomeIcon icon={faHome} className="text-blue-400" /> Home
              </Link>{" "}
            </p>
          ...
          <div className="bg-slate-500 mt-3">
            ...
            <img
              src={userData?.avatar}
              className="size-10 rounded-full mx-auto mt-4"
            />
            ...
            <div className="flex justify-between pb-1">
              <p className="pl-3">
                <FontAwesomeIcon icon={faMessage} /> {userData?.email}
              </p>
              <p className="pr-3">
                <Link to={"/Changedetail"}>
                  <FontAwesomeIcon icon={faPen} />
            ...
            <div className="flex justify-between pb-1">
              <p className="pl-3">
                <FontAwesomeIcon icon={faContactBook} /> {userData?.mobile_no}
              </p>
              <p className="pr-3">
                <Link to={"/Changedetail"}>
                  <FontAwesomeIcon icon={faPen} />
